...
<script>
	$(function(){
		...
		$('.clearfix').find('#regtab_'+table).addClass("targetted");
		$('#recordtable').DataTable({
			'ordering':false,
		});
		$('.delBtn').on("click",function(){return confirm("Are you sure to delete this record?")});
	});
</script>
...
<div class="top-brands">
	<div class="container">
		...
		?>
		<?php
		if($table != 'topup' && $table !='redeem')
		{
			?>
			<a href="<?=isset($functionName)?$functionName:null?>">Register a new <?=$table?></a>
			<?php
		}
		?>
	</div>
