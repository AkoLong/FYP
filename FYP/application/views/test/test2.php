...
$(function(){
	...
	$('.addtocart').on("click",function(){
		...
		var id1 = $(img1).prev();
		var id = $(id1).html();
		var string1 = "<input type='text' value ='"+id+"' disabled='true'/><input type='text' value ='"+img+"' disabled='true'/><input type='text' value ='"+name+"' disabled='true'/><input type='text' value ='"+price+"' disabled='true'/>";
